              ...
              <div className="chk-form-step">
                ...
                <div className="payment-options-grid">
                  ...
                  >
                    ...
                    <div className="pm-info">
                      ...
                      <span>Pay cash or scan QR when biryani arrives</span>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="pm-info">
                      ...
                      <span>Pay via GPay, PhonePe, Paytm or QR</span>
                    </div>
                  </button>
                </div>
                ...
                {paymentMethod === 'COD' && (
                  <div className="cod-info-box">
                    <p>💵 <strong>Cash or QR on Delivery</strong>: Keep exact cash ready or pay via any UPI app when our delivery executive arrives at your doorstep.</p>
                  </div>
                )}
                ...
                {paymentMethod === 'COD' && (
                  <button
                    type="button"
                    className="chk-action-btn whatsapp-submit"
                    disabled={coLoading}
